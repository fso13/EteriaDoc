...
-  **Очарованный горожанин (Enthralled Commoner)**

   -  Средний гуманоид (любая раса), без мировоззрения

   -  **КД** 11 (кожаный доспех) | **Хиты** 10 (4к8) | **Скорость** 30 ft.

   -  **СИЛ** 10 (0) **ЛОВ** 10 (0) **ТЕЛ** 10 (0) **ИНТ** 10 (0) **МУД** 10 (0) **ХАР** 10 (0)

   -  **Чувства:** пассивное Внимание 10

   -  **Языки:** один любой (обычно Общий)

   -  **Действия:** **Дубинка.** Рукопашная атака оружием: +2 к попаданию, досягаемость 5 ft., одна цель. Попадание: 2 (1к4) дробящего урона.

   -  **Особость: Остекленевший Взгляд.** Существо имеет преимущество на спасброски против эффектов, вызывающих испуг.

-  **Кассиан-Марионетка (Cassian, the Puppet)**

   -  Использует статблок **Ветерана**.

   -  **Тактика:** Атакует ближайшего противника в лоб, без какой-либо стратегии. Не использует Second Wind, так как Режиссёр не заботится о сохранности "куклы".

-  **Режиссёр, Зеркальный Фантом (The Director, Mirror Phantom)**

   -  Статблок представлен выше в разделе "Босс".